...
There are some client side requirements to use the PIM. Please check that everything is OK by looking at :doc:`/reference/technical_information/client_side_compatibilities`.
...
.. note::
    ...
    :doc:`/developer_guide/installation/system_requirements/system_requirements`.
...
.. tip::
    ...
    The :doc:`/developer_guide/migration/index` documentation explains how to update your PIM to the most recent minor version.
...
Once the calculations made, please have a look at our :doc:`/reference/scalability_guide/index` and :doc:`/reference/performances_guide/index`.
...
Sorry to hear that. It seems it's :doc:`/troubleshooting/bug_qualification/index` time.
