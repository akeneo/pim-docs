...
- ``oro_access_group``: which stores the user groups
...
The two last numbers mean that you give respectively 'edit' and 'execution' permissions. Otherwise use 0 instead.
