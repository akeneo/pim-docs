...
.. note::
  ...
  A new system has been introduced, the old system has been deprecated but is kept, both systems are useable in 1.4 but we strongly advise to use the new system.
