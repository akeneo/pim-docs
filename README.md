...
- Open [the list of merged PR in 3.0 branch](https://circleci.com/gh/akeneo/workflows/pim-docs/tree/3.0) in Circle CI. You have to be connected with your Github account.
- Click on the first row which should be "On hold"

![List of merged PR in 3.0](.circleci/list_workflows.jpg)
