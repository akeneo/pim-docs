...
<https://github.com/akeneo/pim-community-dev/tree/4.0/src/Akeneo/Tool/Bundle/BatchBundle>`_ in order to run mass edit in the background. Readers and Writers are already
