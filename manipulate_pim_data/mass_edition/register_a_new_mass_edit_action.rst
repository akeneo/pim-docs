...
<https://github.com/akeneo/pim-community-dev/tree/v2.1.0/src/Akeneo/Bundle/BatchBundle>`_ in order to run mass edit in the background. Readers and Writers are already
