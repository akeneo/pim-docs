...
<https://github.com/akeneo/pim-community-dev/blob/v2.2.0/features/Context/Page/Role/Edit.php#L19>`_
...
<https://github.com/akeneo/pim-community-dev/blob/v2.2.0/features/Pim/Behat/Context/Domain/System/PermissionsContext.php>`_.
...
<https://github.com/akeneo/pim-community-dev/blob/v2.2.0/features/Context/Page/Role/Edit.php>`_.
...
in the `Role folder <https://github.com/akeneo/pim-community-dev/tree/v2.2.0/features/Context/Page/Role>`_ for example.
...
<https://github.com/akeneo/pim-community-dev/blob/v2.2.0/features/Pim/Behat/Decorator/Permission/PermissionDecorator.php>`_
...
<https://github.com/akeneo/pim-community-dev/blob/v2.2.0/features/Pim/Behat/Decorator/ElementDecorator.php>`_.
