...
.. code-block:: bash
    ...
    cp -r crowdin_archive/4.0/Community/* your_app/vendor/akeneo/pim-community-dev/

If you use the Enterprise Edition, run this command too:

.. code-block:: bash

    cp -r crowdin_archive/4.0/Enterprise/* your_app/vendor/akeneo/pim-enterprise-dev/
