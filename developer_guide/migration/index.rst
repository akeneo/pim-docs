...
.. note::
   ...
   If you gett a 500 error after upgrading and clear cache aint working try to clear the apc cache with a php script or restart Apache/Web server.
