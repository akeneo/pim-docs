...
sed -i -e "s/^version =.*/version = '1.4'/" /home/akeneo/pim-docs/data/conf.py
...
if [ "$DEPLOY" == true ]; then
    rsync -e "ssh -p $PORT" -avz /home/akeneo/pim-docs/data/pim-docs-build/* $USERNAME@$HOST:/var/www/1.4
fi
