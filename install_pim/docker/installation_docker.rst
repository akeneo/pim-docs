...
To accelerate the installation of the PIM dependencies, `Composer cache <https://github.com/akeneo/pim-community-dev/blob/v2.1.9/docker-compose.yml.dist#L16>`_ and `Yarn cache <https://github.com/akeneo/pim-community-dev/blob/v2.1.9/docker-compose.yml.dist#L30>`_ are shared between the host and the containers.
