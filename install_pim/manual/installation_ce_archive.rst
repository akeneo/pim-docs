...
.. code-block:: bash
    ...
    $ wget https://download.akeneo.com/pim-community-standard-v3.2-latest-icecat.tar.gz #for icecat version
    $ wget https://download.akeneo.com/pim-community-standard-v3.2-latest.tar.gz #for minimal version
