...
In the following example, Akeneo Onboarder version 3.2.x has just been released and we are using an Akeneo PIM version 3.2.x.
...
Double check in the output of this command that the 3.2.x version has been fetched, you can also check it by using the following command:
