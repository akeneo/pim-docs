...
.. note::
    You can see available notification icons on the `styleguide website <https://docs.akeneo.com/2.1/design_pim/styleguide/index.php#Templates-AknNotification>`_.
