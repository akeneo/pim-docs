...
.. note::
  ...
  A new system has been introduced, the old system has been deprecated but is kept, both systems are usable in 1.4 but we strongly recommend using the new system.
