...
RUN service mysql start && chmod +x /wait_for_mysql.sh && /wait_for_mysql.sh && \
    ...
    cp /home/akeneo/pim-docs/pim-community-dev-2.1/app/config/parameters.yml.dist /home/akeneo/pim-docs/pim-community-dev-2.1/app/config/parameters.yml && \
...
RUN rm -rf /root/.composer/cache && \
    cd /home/akeneo/pim-docs/pim-community-dev-2.1/ && ls | grep -v "vendor\|web" | xargs rm -rf
