...
RUN chmod +x /home/akeneo/pim-docs/build.sh && \
    ...
    cd /home/akeneo/pim-docs/pim-community-dev-1.7/ && ls | grep -v vendor | xargs rm -rf && \
    cd /home/akeneo/pim-docs/pim-community-dev-1.7/vendor/ && ls | grep -v sensio | xargs rm -rf && \
