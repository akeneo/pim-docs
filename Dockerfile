...
RUN chmod +x /home/akeneo/pim-docs/build.sh && \
    ...
    #
    # Install Akeneo PIM
RUN cd /home/akeneo/pim-docs/pim-community-dev-2.0/ && \
...
RUN service mysql start && chmod +x /wait_for_mysql.sh && /wait_for_mysql.sh && \
    ...
    cp /home/akeneo/pim-docs/pim-community-dev-2.0/app/config/parameters.yml.dist /home/akeneo/pim-docs/pim-community-dev-2.0/app/config/parameters.yml && \
