...
RUN chmod +x /home/akeneo/pim-docs/build.sh && \
    ...
    wget https://github.com/akeneo/pim-community-dev/archive/3.2.zip -P /home/akeneo/pim-docs/ && \
    unzip /home/akeneo/pim-docs/3.2.zip -d /home/akeneo/pim-docs/ && \
    #
    # Install Akeneo PIM
    cd /home/akeneo/pim-docs/pim-community-dev-3.2/ && \
...
RUN service mysql start && chmod +x /wait_for_mysql.sh && /wait_for_mysql.sh && \
    ...
    cp /home/akeneo/pim-docs/pim-community-dev-3.2/app/config/parameters.yml.dist /home/akeneo/pim-docs/pim-community-dev-3.2/app/config/parameters.yml && \
    cd /home/akeneo/pim-docs/pim-community-dev-3.2/ && php bin/console doctrine:schema:create --env=prod && \
    cd /home/akeneo/pim-docs/pim-community-dev-3.2/ && php bin/console pim:installer:assets --env=prod && \
    cd /home/akeneo/pim-docs/pim-community-dev-3.2/ && sed -i "s#replace: '/bundles'#replace: '../bundles'#" frontend/build/compile-less.js && \
    cd /home/akeneo/pim-docs/pim-community-dev-3.2/ && yarn install && yarn less
    #
    # Clean
RUN rm -rf /root/.composer/cache && \
    cd /home/akeneo/pim-docs/pim-community-dev-3.2/ && ls | grep -v "vendor\|web" | xargs rm -rf